//Navigation Bar
let titileBar=document.createElement('div');
titileBar.setAttribute('class','navi');
titileBar.innerHTML=`
...
<input type="text" class="form-control" id="inputText" placeholder="Search me as cute, gif">
<button type="button" onclick="search()" class="btn btn-success searchBtn">Search</button>`
